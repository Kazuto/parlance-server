...
const (
	...
	UserServiceName = "parlance.v1.UserService"
)
...
const (
	...
	UserServiceListUsersProcedure = "/parlance.v1.UserService/ListUsers"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/parlance.v1.UserService/GetUser"
	// UserServiceCreateUserProcedure is the fully-qualified name of the UserService's CreateUser RPC.
	UserServiceCreateUserProcedure = "/parlance.v1.UserService/CreateUser"
...
// UserServiceClient is a client for the parlance.v1.UserService service.
...
// NewUserServiceClient constructs a client for the parlance.v1.UserService service. By default, it
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_parlance_v1_user_proto.Services().ByName("UserService").Methods()
...
// GetUser calls parlance.v1.UserService.GetUser.
...
// CreateUser calls parlance.v1.UserService.CreateUser.
...
// UpdateUser calls parlance.v1.UserService.UpdateUser.
...
// DeleteUser calls parlance.v1.UserService.DeleteUser.
...
// UserServiceHandler is an implementation of the parlance.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/parlance.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) AssignRole(context.Context, *connect.Request[v1.AssignRoleRequest]) (*connect.Response[v1.AssignRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.UserService.AssignRole is not implemented"))
}
