...
const (
	...
	PermissionServiceName = "parlance.v1.PermissionService"
)
...
const (
	...
	// ListPermissions RPC.
	PermissionServiceListPermissionsProcedure = "/parlance.v1.PermissionService/ListPermissions"
...
func NewPermissionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PermissionServiceClient {
	...
	permissionServiceMethods := v1.File_parlance_v1_permission_proto.Services().ByName("PermissionService").Methods()
...
// GetPermission calls parlance.v1.PermissionService.GetPermission.
...
func (UnimplementedPermissionServiceHandler) ListPermissions(context.Context, *connect.Request[v1.ListPermissionsRequest]) (*connect.Response[v1.ListPermissionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.PermissionService.ListPermissions is not implemented"))
}
