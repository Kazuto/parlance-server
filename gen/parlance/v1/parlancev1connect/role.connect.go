...
const (
	...
	RoleServiceName = "parlance.v1.RoleService"
)
...
const (
	...
	RoleServiceListRolesProcedure = "/parlance.v1.RoleService/ListRoles"
	// RoleServiceGetRoleProcedure is the fully-qualified name of the RoleService's GetRole RPC.
	RoleServiceGetRoleProcedure = "/parlance.v1.RoleService/GetRole"
	// RoleServiceCreateRoleProcedure is the fully-qualified name of the RoleService's CreateRole RPC.
	RoleServiceCreateRoleProcedure = "/parlance.v1.RoleService/CreateRole"
...
func NewRoleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RoleServiceClient {
	...
	roleServiceMethods := v1.File_parlance_v1_role_proto.Services().ByName("RoleService").Methods()
...
// GetRole calls parlance.v1.RoleService.GetRole.
...
// CreateRole calls parlance.v1.RoleService.CreateRole.
...
// UpdateRole calls parlance.v1.RoleService.UpdateRole.
...
// DeleteRole calls parlance.v1.RoleService.DeleteRole.
...
func (UnimplementedRoleServiceHandler) ListRoles(context.Context, *connect.Request[v1.ListRolesRequest]) (*connect.Response[v1.ListRolesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.RoleService.ListRoles is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) GetRole(context.Context, *connect.Request[v1.GetRoleRequest]) (*connect.Response[v1.GetRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.RoleService.GetRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) CreateRole(context.Context, *connect.Request[v1.CreateRoleRequest]) (*connect.Response[v1.CreateRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.RoleService.CreateRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) UpdateRole(context.Context, *connect.Request[v1.UpdateRoleRequest]) (*connect.Response[v1.UpdateRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("parlance.v1.RoleService.UpdateRole is not implemented"))
}
